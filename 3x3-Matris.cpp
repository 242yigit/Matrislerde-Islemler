...
do
{
cout << "3x3 A Matrisi Icın Degerleri Giriniz  : " << endl;
cout << "a11 : ";
cin >> a11;
cout << "a12 : ";
cin >> a12;
...
cout << "3x3 B Matrisi Icın Degerleri Giriniz : " << endl;
cout << "b11 : ";
cin >> b11;
cout << "b22 : ";
cin >> b12;
...
cout << "Yapmak Istediginiz Islemi Seciniz ( Toplama / Carpma / Determinant):"<< endl;
cin >> islem;
if(islem == "Toplama")
{
cout << "A ve B Matrislerinin Toplami : " << endl;
...
{
cout << "A ve B Matrislerinin Carpimi : " << endl;
...
{
cout<<" Hatali Islem Lutfen Tekrar Deneyiniz !!! "<<endl;
break;
}
cout << "Islem Yapmaya Devam Etmek Ister Misiniz (E/H) ? " << endl;
cin >> durum;
} 
while(durum == 'E');
